<template>
    <div class="card" style="margin-bottom: 15px;margin-top: -25px">
        <div class="card-header">
            <h3 class="card-title">Account Source</h3>
        ...
        <div class="card-body">
            <el-form :inline="true" :model="formInline" class="demo-form-inline" size="small" :label-position="'right'"
                ...
                <!--<el-form-item label="Region">-->
                    <!--<el-select v-model="formInline.region" placeholder="Select a region">-->
    ...
    <el-table :data="accountSourcesRef" style="width: 100%" height="550" size="default" v-loading="loading">
        ...
        <el-table-column prop="alternativeName" label="Abbreviation" width="200"/>
        ...
        <el-table-column prop="" label="Supported Currencies" width="180"/>
