<template>
    <div v-if="isEdit === false">
        <el-page-header content="Add New Recipient" @back="$router.go(-1)" style="margin-top: -25px;margin-bottom: 15px"/>
    </div>
    <div v-if="isEdit === true">
        <el-page-header content="Edit Recipient" @back="$router.go(-1)" style="margin-top: -25px;margin-bottom: 15px"/>
    </div>
